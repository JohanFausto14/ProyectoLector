...
export default function DiagnosticoModal({ libroId, preguntas, onComplete }: DiagnosticoModalProps) {
  ...
  if (resultado) {
    ...
    return (
      <div className="fixed inset-0 z-[300] flex items-center justify-center px-4"
        ...
        <div className="bg-[#f5f8ff] rounded-3xl w-full max-w-md shadow-2xl overflow-hidden"
          style={{ animation: 'scaleInModal 0.35s cubic-bezier(0.34,1.56,0.64,1) both' }}>

          {/* Header dorado */}
          <div className="bg-[#0a1628] px-8 pt-8 pb-6 text-center">
          ...
          <div className="px-8 py-6 space-y-4">
            ...
            <p className="text-sm text-[#1e3a6e] font-lora leading-relaxed text-center">
              {nivelInfo.desc}
            </p>
            ...
            <div className="flex items-center gap-3 bg-[#f5f0e8] rounded-xl px-4 py-3">
              ...
              <p className="text-xs text-[#1e3a6e] font-lora">
            ...
            <button
              ...
              className="w-full py-3.5 rounded-xl bg-[#0a1628] text-[#f5f8ff] font-bold hover:bg-[#1e3a6e] transition-all shadow-lg flex items-center justify-center gap-2"
            >
  ...
  return (
    <div className="fixed inset-0 z-[300] flex items-center justify-center px-4"
      ...
      <div className="bg-[#f5f8ff] rounded-3xl w-full max-w-lg shadow-2xl flex flex-col max-h-[90vh]"
        style={{ animation: 'scaleInModal 0.3s cubic-bezier(0.34,1.56,0.64,1) both' }}>

        {/* Header */}
        <div className="px-6 pt-6 pb-4 border-b border-[#c8d8f0] shrink-0">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h2 className="font-playfair font-bold text-[#0a1628] text-lg leading-none">Diagnóstico inicial</h2>
              <p className="text-[10px] text-[#6b8cba] font-bold uppercase tracking-widest mt-0.5">
          ...
          <div className="space-y-1.5">
            <div className="flex justify-between text-[10px] font-black text-[#6b8cba] uppercase tracking-widest">
              <span>Pregunta {currentIdx + 1} de {totalPreguntas}</span>
              <span>{progressPct}%</span>
            </div>
            <div className="w-full h-1.5 bg-[#c8d8f0] rounded-full overflow-hidden">
              <div
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5">
          <div className="bg-white rounded-2xl p-5 border border-[#c8d8f0] shadow-sm">
            {/* Pregunta */}
            <div className="flex items-start gap-2.5 mb-5">
              ...
              <p className="font-medium text-[#0a1628] text-sm leading-relaxed">{preguntaActual.texto}</p>
            </div>
        ...
        {/* Footer */}
        <div className="px-6 pb-6 pt-4 border-t border-[#c8d8f0] shrink-0 flex gap-3">
          {currentIdx > 0 && (
            <button
              onClick={handleAnterior}
              className="px-4 py-3 rounded-xl border border-[#c8d8f0] text-[#1e3a6e] font-bold hover:bg-white transition-all text-sm flex items-center gap-2"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {!esUltimaPregunta ? (
            ...
            <button
              ...
              className="flex-1 py-3 rounded-xl bg-[#d4af37] text-[#0a1628] font-bold hover:bg-[#c19b2f] transition-all shadow-lg disabled:opacity-40 disabled:pointer-events-none flex items-center justify-center gap-2"
            >
              {isSubmitting ? (
                <>
